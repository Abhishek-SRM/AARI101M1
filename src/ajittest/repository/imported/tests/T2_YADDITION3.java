...
public class T2_YADDITION3 {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T2_YADDITION3.xml";
	String input;
	...
	public T2_YADDITION3(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T2_YADDITION3");
	}
