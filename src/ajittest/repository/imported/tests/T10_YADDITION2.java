...
public class T10_YADDITION2 {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T10_YADDITION2.xml";
	String input;
	...
	public T10_YADDITION2(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T10_YADDITION2");
	}
