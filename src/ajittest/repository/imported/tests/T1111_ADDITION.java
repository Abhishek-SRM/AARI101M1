...
public class T1111_ADDITION {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T1111_ADDITION.xml";
	String input;
	...
	public T1111_ADDITION(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T1111_ADDITION");
	}
