...
public class T1_YADDITION1 {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T1_YADDITION1.xml";
	String input;
	...
	public T1_YADDITION1(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T1_YADDITION1");
	}
