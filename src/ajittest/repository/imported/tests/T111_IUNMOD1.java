...
public class T111_IUNMOD1 {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T111_IUNMOD1.xml";
	String input;
	...
	public T111_IUNMOD1(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T111_IUNMOD1");
	}
}