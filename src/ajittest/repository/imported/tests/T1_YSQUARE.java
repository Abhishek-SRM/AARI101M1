...
public class T1_YSQUARE {

	static String inputXMLFilePath = "testcases/ajittest.repository.imported.tests/T1_YSQUARE.xml";
	String input;
	...
	public T1_YSQUARE(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/ajittest.repository.imported.tests/T1_YSQUARE");
	}
